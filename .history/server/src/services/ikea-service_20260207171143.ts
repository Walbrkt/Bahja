...
export async function searchIkeaProducts({
  ...
  try {
    ...
    const searchUrl = buildIkeaSearchUrl(query, category);
...
function getMockProducts({
  ...
  // Import mock catalog from server.ts
  const MOCK_CATALOG: IkeaProduct[] = [
    {
      id: "sofa-kivik",
      name: "KIVIK 3-seat sofa",
      description: "A generous seating series with soft, deep seats and a timeless design.",
      price: 699,
      currency: "EUR",
