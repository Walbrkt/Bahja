    ...
    return (
      <div className="app">
        <div className="empty-state">
          <h1 style={{ fontSize: "32px", marginBottom: "16px" }}>🏠 Interior Architect</h1>
          <p style={{ fontSize: "18px", marginBottom: "32px", color: "#666" }}>
            Upload your room photo to get started
          </p>
          <div style={{ marginTop: "24px", display: "flex", flexDirection: "column", alignItems: "center", gap: "24px" }}>
            ...
            >
              ...
              <span style={{ fontSize: "24px", fontWeight: 600, color: "#4f46e5", marginBottom: "8px" }}>
                Click to upload room photo
              </span>
              <span style={{ fontSize: "14px", color: "#888" }}>or drag and drop</span>
              <span style={{ fontSize: "13px", color: "#aaa", marginTop: "8px" }}>JPG, PNG up to 10MB</span>
              <input
                type="file"
                accept="image/*"
                style={{ display: "none" }}
            ...
            {roomImageUrl && !isLoading && (
              <div style={{ width: "100%", maxWidth: "600px", textAlign: "center" }}>
                <img
                  src={roomImageUrl}
                  alt="Room preview"
                  style={{ width: "100%", borderRadius: "12px", border: "3px solid #4f46e5", marginBottom: "16px" }}
                />
                <p style={{ color: "#4f46e5", fontWeight: 600 }}>✓ Image uploaded - loading furniture...</p>
              </div>
            )}
            ...
            {!roomImageUrl && (
              <>
                <div style={{ display: "flex", alignItems: "center", width: "100%", maxWidth: "600px", gap: "12px" }}>
                  ...
                  <span style={{ color: "#999", fontSize: "13px", fontWeight: 500 }}>OR PASTE URL</span>
                  <div style={{ flex: 1, height: "1px", backgroundColor: "#ddd" }} />
                </div>
                ...
                <div style={{ width: "100%", maxWidth: "600px" }}>
                  <input
                    ...
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' && roomImageUrl && !roomImageUrl.startsWith('data:')) {
                  ...
                  <button
                    className="btn btn--primary"
                    onClick={() => roomImageUrl && !roomImageUrl.startsWith('data:') && callTool({ imageUrl: roomImageUrl })}
                    disabled={!roomImageUrl || roomImageUrl.startsWith('data:') || isLoading}
                    style={{ width: "100%", marginTop: "12px", padding: "16px", fontSize: "16px" }}
                  >
                    {isLoading ? "Loading catalogue..." : "Browse Furniture →"}
                  </button>
                </div>
              </>
            )}
